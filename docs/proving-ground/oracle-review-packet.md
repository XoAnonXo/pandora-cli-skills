...
- `docs/proving-ground/overnight-research-module.md`
...
oracle --engine browser --model gpt-5.2-pro --slug "overnight-loop-review" \
  -p "$(cat docs/proving-ground/oracle-review-packet.md)" \
  --file "docs/proving-ground/overnight-research-module.md" \
