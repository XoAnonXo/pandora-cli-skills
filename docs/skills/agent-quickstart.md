...
- public publication is live:
  ...
  - `pip install pandora-agent==0.1.0a10`
...
- standalone package identity: `pandora-agent`
 - external install path: public PyPI package `pandora-agent==0.1.0a10` or signed GitHub release wheel or sdist attached to the tagged Pandora release
