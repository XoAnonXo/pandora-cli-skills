...
function loadResearchConfig(configPath, options = {}) {
  const resolvedPath = path.resolve(
    ...
    configPath || 'proving-ground/autoresearch/config/proving-ground.example.json',
  );
  ...
  return {
    ...
    reportDir: normalizeText(document.reportDir) || 'proving-ground/autoresearch/reports',
